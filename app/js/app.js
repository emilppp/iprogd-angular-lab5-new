...
var dinnerPlannerApp = angular.module('dinnerPlanner', ['ngRoute','ngResource', 'ngSanitize', 'ngCookies', 'ngStorage']);
...
dinnerPlannerApp.config(['$routeProvider',
  function($routeProvider) {
    $routeProvider.
      ...
      when('/dish/:searchType/:dishId', {
        templateUrl: 'partials/dish.html',
        controller: 'DishCtrl'
      }).
      when('/overview', {
        templateUrl: 'partials/dinner-overview.html',
